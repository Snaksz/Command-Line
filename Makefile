...
# Extra Tests
extratrace01:
	$(DRIVER) -t extratrace01.txt -s $(TSHREF) -a $(TSHARGS)
extratrace02:
	$(DRIVER) -t extratrace02.txt -s $(TSHREF) -a $(TSHARGS)
extratrace03:
	$(DRIVER) -t extratrace03.txt -s $(TSHREF) -a $(TSHARGS)
extratrace04:
	$(DRIVER) -t extratrace04.txt -s $(TSHREF) -a $(TSHARGS)
extratrace05:
	$(DRIVER) -t extratrace05.txt -s $(TSHREF) -a $(TSHARGS)
